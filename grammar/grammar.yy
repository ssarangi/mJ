...
mainclass	: TClass TId TLBraces TPublic TStatic TVoid TMain TLParen TString TLBracket TRBracket TId TRParen TLBraces stmtlist TRBraces TRBraces { $$ = new MainClass($2, $12, $15); }
					;
...
vardecllist	: vardecl vardecllist { VarList* list = new VarList(); list->insert($1); list->insert($2); $$ = list; delete $2; }
						| { $$ = new VarList(); }
						;
